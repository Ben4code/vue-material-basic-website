<template>
    <div class="anim_container">
        ...
        appear
        >
            <div class="icon icon_phone" deley="0" left="100"></div>
        </transition>
        ...
        appear
        >
            <div class="plus one" deley="100" left="300">+</div>
        </transition>
        ...
        appear
        >
            <div class="icon icon_delivery" deley="200" left="480"></div>
        </transition>
        ...
        appear
        >
            <div class="plus" deley="300" left="750">=</div>
        </transition>
        ...
        appear
        >
            <div class="icon icon_pizza" deley="400" left="900"></div>
        </transition>
